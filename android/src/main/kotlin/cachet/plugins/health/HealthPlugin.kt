...
class HealthPlugin(private var channel: MethodChannel? = null) : MethodCallHandler,
  ...
  // The following static function (registerWith) has been removed as it uses the deprecated V1 embedding API (Registrar).
  // The plugin now relies entirely on the V2 embedding API (onAttachedToEngine, onAttachedToActivity).
